---
lightbox: auto
title: "Working with Noisy Quantum Hardware"
...
open-graph:
  title: "Working with Noisy Quantum Hardware: from theory to practice"
...
citation:
  ...
  type: speech
  abstract: |
    Current quantum computers have enough qubits to surpass what we can simulate on classical machines. So why aren’t we seeing quantum advantage papers every week? While devices are getting larger, they're still fundamentally limited by noise. In this talk, I’ll explain what makes quantum noise especially tricky to deal with, and share some of the methods we use to reduce its impact. I’ll cover both the theory behind Quantum Error Mitigation (QEM) methods and how they’re applied in practice, particularly through software.
...
[{{< meta date >}} @ [Quantum@UW](https://quantumreu.cs.washington.edu/) Seminar]{.dim-text style="text-align:left;'}
:::
...
::: {.callout-note title="Background" .fragment}
- [2013-2017]<br>
  Math + Physics @ [NYU]{.purple-text}
- [2017-2021]<br>
  Developer @ [Overleaf]{.green-text}
- [2020-2022]<br>
  Quantum @ [U Waterloo]{.orange-text}
- [2022-]<br>
  [UF]{.yellow-text}
:::
...
::: {.columns}
::: {.column width=70%}
<img src="assets/stack.jpg" width="800">
:::
...
- `git`/GitHub
- numerics packages (numpy/scipy)
- quantum SDK (qiskit, cirq, pennylane, ...) 

Other

- software eng. skills: testing, documentation, API design, ...
- technical writing
:::
:::
